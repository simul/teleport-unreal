...
#include "TeleportInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UTeleportInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UTeleportInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UTeleportInteractiveTool* NewTool = NewObject<UTeleportInteractiveTool>(SceneState.ToolManager);
...
UTeleportInteractiveToolProperties::UTeleportInteractiveToolProperties()
{
...
void UTeleportInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UTeleportInteractiveTool::Setup()
{
	...
	Properties = NewObject<UTeleportInteractiveToolProperties>(this, "Measurement");
...
void UTeleportInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UTeleportInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTeleportInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UTeleportInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UTeleportInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UTeleportInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UTeleportInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UTeleportInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UTeleportInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
