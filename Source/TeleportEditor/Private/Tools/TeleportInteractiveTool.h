...
#include "TeleportInteractiveTool.generated.h"


/**
 * Builder for UTeleportInteractiveTool
 */
UCLASS()
class TELEPORTEDITOR_API UTeleportInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UTeleportInteractiveTool
 */
UCLASS(Transient)
class TELEPORTEDITOR_API UTeleportInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UTeleportInteractiveToolProperties();
...
/**
 * UTeleportInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class TELEPORTEDITOR_API UTeleportInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UTeleportInteractiveToolProperties> Properties;
