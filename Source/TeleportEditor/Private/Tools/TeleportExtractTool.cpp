...
#define LOCTEXT_NAMESPACE "UTeleportExtractTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UTeleportExtractToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UTeleportExtractTool* NewTool = NewObject<UTeleportExtractTool>(SceneState.ToolManager);
...
UTeleportExtractToolProperties::UTeleportExtractToolProperties()
{
...
void UTeleportExtractTool::SetWorld(UWorld* World)
{
	check(World);
...
void UTeleportExtractTool::Setup()
{
	...
	Properties = NewObject<UTeleportExtractToolProperties>(this, "Measurement");
...
void UTeleportExtractTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UTeleportExtractTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UTeleportExtractTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UTeleportExtractTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UTeleportExtractTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UTeleportExtractTool::UpdatePosition(const FRay& WorldRay)
{
...
void UTeleportExtractTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UTeleportExtractTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UTeleportExtractTool::Render(IToolsContextRenderAPI* RenderAPI)
{
